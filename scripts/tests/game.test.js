...
describe("gameplay works correctly", () => {
    ...
    test("add turn adds new turn to the game", () => {
        addTurn();
    ...
    test("turnInProgress key is set to true during computer's showTurns", () => {
        showTurns();
        expect(game.turnInProgress).toBe(true);
     });
     test("clicking during computer's showTurns should fail", () => {
        showTurns();
        game.lastButton = "";
